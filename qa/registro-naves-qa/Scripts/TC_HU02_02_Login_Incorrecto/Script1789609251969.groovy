...
// HU-02, negativo: con la contrasena equivocada no queda sesion abierta.
...
login.setBodyContent(new HttpTextBodyContent(
    'correo=agente@navesitas.pa&password=ClaveEquivocada999'))
...
WS.verifyMatch(r.getResponseBodyContent(), '.*"autenticado":false.*', true)
